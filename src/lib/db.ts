 ...
 * resets. Hosted MongoDB and intermediate NATs close idle TCP connections, and
 * Prisma does not retry `$runCommandRaw` the way it retries model operations.
 * On the next attempt the driver opens a fresh socket from the pool.
